(function(namespace) {
	...
	function keydown(e) {
        if (e.keyCode === SPACE_BAR_CODE) {
			...
			localStorage.setItem('addCacti',true);
		}
    }
	...
	//document.getElementById('addCactus').addEventListener('click', addCactiBtn)
	...
	// Game.prototype.addCactiBtn = function() {
	// 	this.updateCacti();
	// }
	// document.getElementById('addCactus').addEventListener('click',function(){
	// 	this.addCacti = true;
	// 	console.log('Cacti Added');
	// });

	// function restart_game(){
	// 	if(this.finished && this.spacePressed){
	// 		this.restart();
	// 	}
	// }
	...
	Game.prototype.step = function(timestamp) {
		console.log(this.finished,"--",spacePressed);
		var flag = localStorage.getItem('addCacti');
